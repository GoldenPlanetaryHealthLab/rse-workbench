...
We have some scripts that already exist in the project, 
so we'll use these to write the prospective `rproject.toml` and `pyproject.toml` files. Using `rg`, we found:
